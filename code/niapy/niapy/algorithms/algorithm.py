...
class Algorithm:
    ...
    def __init__(self, individual_type=None, seed=None, *args, **kwargs):
    ...
    def run(self, task, *args, **kwargs):
        ...
        Args:
            task (Task): Task for the algorithm.
            args (list): Additional list parameters.
...
class AnalysisAlgorithm(Algorithm):
    ...
    def run(self, task, *args, **kwargs):
        r"""Start the analysis run.

        Args:
            task (Task): Task too analys.
            args (list): Additional list parameters.
            kwargs (dict): Additional keyword parametes.

        Returns:
            list[Union[list[int], list]]: Groups.

        See Also:
            * :func:`niapy.algorithms.Algorithm.run`

        """
        return [[i] for i in range(task.dimension)]
