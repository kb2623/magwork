...
V tem poglavju bomo opravili pregled pomembnih del za izbrano problematiko, ki obsega optimizacijo problemov velikih dimenzij, 
% TODO
...
\begin{algorithm}
    ...
    \caption{\textbf{Algoritem TRDG za dekompozicijo problema.}}
    \label{pcode:trdg}
\end{algorithm}
...
\begin{algorithm}
	...
	\caption{\textbf{Funkcija za grupiranje komponent.}}
